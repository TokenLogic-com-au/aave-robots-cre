...
update :; forge update
install :; forge install && npm install && npm --prefix workflows/shared/offchain install && npm --prefix workflows/fee-shares-minter/offchain install && npm --prefix workflows/gsm-freezer/offchain install
...
typecheck-gsm-freezer :; cd workflows/gsm-freezer/offchain && npm run typecheck
test-offchain-gsm-freezer :; cd workflows/gsm-freezer/offchain && npm test
